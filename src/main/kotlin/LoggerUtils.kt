...
private var environment = System.getenv("K2S3_ENVIRONMENT") ?: UNSET_TEXT
private var app_version = System.getenv("K2S3_IMAGE_DIGEST") ?: UNSET_TEXT
private var component = System.getenv("K2S3_JAR_COMPONENT_NAME") ?: "jar_file"
private var application = System.getenv("K2S3_APPLICATION_NAME") ?: "Kafka2S3"
